...
export default function ModernFrenchPage() {
  ...
  useEffect(() => {
    const fetchLecons = async () => {
      try {
        ...
        const filtered = items.filter(l => l.hub?.toLowerCase().includes('modern french'));
        setLecons(filtered);
      } catch (error) {
          ...
          <div className="max-w-[120rem] mx-auto px-6 lg:px-12">
            ...
            >
              ...
              <p className="font-paragraph text-lg lg:text-xl opacity-90">
                Discover how native French speakers actually communicate in everyday life.
              </p>
            </motion.div>
          </div>
        </section>
